...
public class Test655 {
     ...
     * Method invocation under test: <com.hermanowicz.pantry.filter.FilterModel: int getVolumeSince()>_2424_4842
     */
    @Test(timeout = 4000)
    public void test_com_hermanowicz_pantry_filter_FilterModel_getVolumeSince_001() throws Exception {
        com.hermanowicz.pantry.filter.FilterModel filtermodel1 = null;
        filtermodel1 = new com.hermanowicz.pantry.filter.FilterModel();
        filtermodel1.getVolumeSince();
    }
}
